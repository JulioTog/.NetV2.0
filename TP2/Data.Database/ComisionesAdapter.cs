...
namespace Data.Database
{
    public class ComisionesAdapter : Adapter
    {
        ...
        public void Delete(int ID)
        {
            ...
            {
                Exception ExceptionManejada = new Exception("Error al eliminar comision", Ex);
            ...
            comision.State = BusinessEntity.States.Unmodified;            
             ...
             protected void Update(Comision comision)
             {
                 try
                 {
                     ...
                     SqlCommand cmdSave = new SqlCommand(
                         "UPDATE comision SET desc_comision = @desc_comision, anio_especialidad = @anio_especialidad, " +
                         "id_plan = @id_plan", sqlConn);
             ...
             protected void Insert(Comision comision)
             {
                 try
                 {
                     this.OpenConnection();
                     SqlCommand cmdSave = new SqlCommand(
                         "insert into comision(desc_comision,anio_especialidad,id_plan)" +
