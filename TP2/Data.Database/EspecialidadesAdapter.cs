...
namespace Data.Database
{
    public class EspecialidadesAdapter : Adapter
    {
        ...
        public void Delete(int ID)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdDelete = new SqlCommand("delete especialidades where id_usuario=@id", sqlConn);
        ...
        protected void Update(Especialidad especialidad)
        {
            try
            {
                ...
                SqlCommand cmdSave = new SqlCommand(
                    "UPDATE especialidades SET desc_especialidad = @desc_especialidad, ", sqlConn);
